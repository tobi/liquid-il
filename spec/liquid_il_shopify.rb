...
LiquidSpec.setup do |ctx|
  ...
  LiquidIL::Filters.singleton_class.class_eval do
    ...
    def img_url(input, size = nil)
      ...
      # Shopify img_url: /assets/filename_size.ext
    ...
    def product_img_url(input, size = nil)
      ...
      # Keep path components (e.g. products/filename.jpg)
...
LiquidSpec.configure do |config|
  ...
  config.missing_features = LiquidSpecAdapterHelper::SHOPIFY_MISSING_FEATURES
end
